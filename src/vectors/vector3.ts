...
export class Vector3 {
  ...
  public setScalar(x?: number | null, y?: number | null, z?: number | null): Vector3 {
    this.x = x ?? this.x;
    this.y = y ?? this.y;
    this.z = z ?? this.z;
    return this;
  ...
  public setArray(array: number[], offset: number = 0): Vector3 {
  ...
  public getDistance(vector: Vector3, square: boolean = false): number {
  ...
  public addScaledVector(vector: Vector3, scalar: number): Vector3 {
  ...
  public subtractScaledVector(vector: Vector3, scalar: number): Vector3 {
    this.x -= vector.x * scalar;
    this.y -= vector.y * scalar;
    this.z -= vector.z * scalar;
    return this;
  ...
  public multiplyScaledVector(vector: Vector3, scalar: number): Vector3 {
    this.x *= vector.x * scalar;
    this.y *= vector.y * scalar;
    this.z *= vector.z * scalar;
    return this;
  ...
  public scale(scalar: number, axis?: 'x' | 'y' | 'z'): Vector3 {
    if (!axis) {
      this.x *= scalar;
      this.y *= scalar;
      this.z *= scalar;
  ...
  public divideScaledVector(vector: Vector3, scalar: number): Vector3 {
    this.x /= vector.x * scalar;
    this.y /= vector.y * scalar;
    this.z /= vector.z * scalar;
    return this;
  ...
  public max(vector: Vector3): Vector3 {
  ...
  public min(vector: Vector3): Vector3 {
  ...
  public absolute(axis?: 'x' | 'y' | 'z'): Vector3 {
    if (!axis) {
  ...
  public opposite(axis?: 'x' | 'y' | 'z'): Vector3 {
    if (!axis) {
      this.x = -this.x;
      this.y = -this.y;
      this.z = -this.z;
  ...
  public floor(axis?: 'x' | 'y' | 'z'): Vector3 {
    if (!axis) {
  ...
  public ceil(axis?: 'x' | 'y' | 'z'): Vector3 {
    if (!axis) {
  ...
  public getAngle(vector: Vector3): number | false {
  ...
  public quadraticBezier(p0: Vector3, p1: Vector3, p2: Vector3, t: number): Vector3 {
  ...
  public cubicBezier(p0: Vector3, p1: Vector3, p2: Vector3, p3: Vector3, t: number): Vector3 {
  ...
  public quadraticBezierDerivative(p0: Vector3, p1: Vector3, p2: Vector3, t: number): Vector3 {
  ...
  public cubicBezierDerivative(p0: Vector3, p1: Vector3, p2: Vector3, p3: Vector3, t: number): Vector3 {
  ...
  public quadraticBezierSplit(p0: Vector3, p1: Vector3, p2: Vector3, t: number, left: Vector3[], right: Vector3[]): void {
    const lx: number[] = [];
    const ly: number[] = [];
    const lz: number[] = [];
    const rx: number[] = [];
  ...
  public cubicBezierSplit(p0: Vector3, p1: Vector3, p2: Vector3, p3: Vector3, t: number, left: Vector3[], right: Vector3[]): void {
    const lx: number[] = [];
    const ly: number[] = [];
    const lz: number[] = [];
    const rx: number[] = [];
  ...
  public quadraticBezierLength(p0: Vector3, p1: Vector3, p2: Vector3, samples?: number): number {
  ...
  public cubicBezierLength(p0: Vector3, p1: Vector3, p2: Vector3, p3: Vector3, samples?: number): number {
    return sampleCurveLength(
  ...
  public quadraticBezierParameterAtLength(p0: Vector3, p1: Vector3, p2: Vector3, distance: number, samples?: number): number {
  ...
  public cubicBezierParameterAtLength(p0: Vector3, p1: Vector3, p2: Vector3, p3: Vector3, distance: number, samples?: number): number {
    return sampleCurveParameterAtLength(
      t => Bezier.cubic(p0.x, p1.x, p2.x, p3.x, t),
      t => Bezier.cubic(p0.y, p1.y, p2.y, p3.y, t),
      t => Bezier.cubic(p0.z, p1.z, p2.z, p3.z, t),
  ...
  public lerp(min: Vector3, max: Vector3, amount: number): Vector3 {
